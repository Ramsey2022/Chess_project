...
# contains script to play chess game
class Game

  class InputError < StandardError
    def message
      'Invalid input! Enter column & row, ie: c4'
    end
  end

  class CoordinatesError < StandardError
    def message
      'Invalid coordinates! Enter column & row of correct color.'
    end
  end
  ...
  class PieceError < StandardError
    def message
      'Invalid piece! This piece has no legal moves.'
    end
  end
